        ...
        <div class="mt-8">
            @if($hasVoted)
                <button
                    ...
                    class="w-20 bg-blue border border-blue hover:bg-hover-blue
                        text-white font-bold text-xxs uppercase rounded-xl
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @if($hasVoted)
                        <button
                            wire:click.prevent="vote"
                            class="w-20 bg-blue border bg-blue font-bold text-xxs text-white
