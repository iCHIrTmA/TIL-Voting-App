<div
  ...
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center">
    ...
    <div
        ...
        class="modal inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle">
      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <form wire:submit.prevent="updateIdea" action="#" method="POST" class="space-y-4 px-4 py-6">
            ...
            <div>
                ...
                @enderror
            <div>
                <textarea wire:model.defer="description" name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 text-sm px-4 py-2" placeholder="Describe your idea"></textarea>
            </div>
                @error('description')
                    <p class="text-red text-xs mt-1">{{ $message }}</p>
                @enderror
